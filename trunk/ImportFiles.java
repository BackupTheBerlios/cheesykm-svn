...
class ImportFiles extends JDialog{
	...
	ImportFiles(String rootPath){
		...
		if(rootPath!=null){
			...
			if(rootFile.isFile()){
				...
				if(CheesyKM.SHOWTOOLTIPS)includeHiddenFiles.setToolTipText(CheesyKM.getLabel("toolTipIncludeHidden"));
				createTopicsInOneTopic=new JRadioButton(CheesyKM.getLabel("createTopicsInOneTopic"));
				if(CheesyKM.SHOWTOOLTIPS)createTopicsInOneTopic.setToolTipText(CheesyKM.getLabel("toolTipInSameTopic"));
				createTopicsInOneTopicN=new JRadioButton(CheesyKM.getLabel("createTopicsInOneTopicN"));
				if(CheesyKM.SHOWTOOLTIPS)createTopicsInOneTopicN.setToolTipText(CheesyKM.getLabel("toolTipNInSameTopic"));
				...
				if(CheesyKM.SHOWTOOLTIPS)registerInOneTopic.setToolTipText(CheesyKM.getLabel("toolTipInSameDoc"));
				registerInOneTopic.setSelected(true);
				registerInOneTopicN=new JRadioButton(CheesyKM.getLabel("registerInOneTopicN"));
				if(CheesyKM.SHOWTOOLTIPS)registerInOneTopicN.setToolTipText(CheesyKM.getLabel("toolTipNInSameDoc"));
				...
				if(CheesyKM.SHOWTOOLTIPS)createTopics.setToolTipText(CheesyKM.getLabel("toolTipCreate"));
				createTopicsN=new JRadioButton(CheesyKM.getLabel("createTopicsForDirsN"));
				if(CheesyKM.SHOWTOOLTIPS)createTopicsN.setToolTipText(CheesyKM.getLabel("toolTipNCreate"));
				...
				if(CheesyKM.SHOWTOOLTIPS)confirm.setToolTipText(CheesyKM.getLabel("toolTipAsk"));
				confirm.setSelected(true);
				confirmN=new JRadioButton(CheesyKM.getLabel("confirmEachDocN"));
				if(CheesyKM.SHOWTOOLTIPS)confirmN.setToolTipText(CheesyKM.getLabel("toolTipNAsk"));
	...
	*/
	...
	private JTree createFolderTree(boolean showFiles,boolean childrenFollow){
		...
		if(CheesyKM.SHOWTOOLTIPS)resu.setToolTipText(CheesyKM.getLabel("toolTipSelectFolder"));
		return resu;
	}
